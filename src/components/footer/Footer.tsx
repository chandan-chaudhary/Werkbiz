    ...
    return(
        <div className={'flex flex-col text-black pt-24'}>
            <div className={'flex flex-col items-center justify-center py-10 space-y-3'}>
                <span className={'text-6xl '}>Ready to do your best work?</span>
            ...
            <footer className=" footer bg-base-200 text-base-content p-10 py-12">
                ...
                <nav>
                    ...
                    <a className="link link-hover underline">##########</a>
                    <a className="link link-hover underline">##########</a>
                    <a className="link link-hover">Email</a>
                    <a className="link link-hover">support@werkbiz.com</a>
                </nav>
            </footer>
            <footer className="footer footer-center bg-base-200 text-base-content p-10">
                ...
                <aside>
                    <p>Copyright © ${new Date().getFullYear()} - All right reserved by Werkbiz Ltd</p>
                </aside>
            </footer>
        </div>
    )
