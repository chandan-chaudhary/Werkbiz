        ...
        <React.Fragment>
            <div
                ...
                <div
                    ...
                    <p className={'text-xl font-bold text-fuchsia-900 sm:max-xl:pb-12  xl:pt-20 xl:px-28 lg:text-2xl xl:text-3xl'}>Reach the right talent pool and build a high-performing blue-collar workforce with our targeted sales and marketing strategies. We understand the unique challenges of blue-collar recruitment and develop customized campaigns to attract top talent.</p>
