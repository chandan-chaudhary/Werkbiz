            ...
            <div
                ...
                </div>
                {
                    softwareSolution.map((feature, i) =>
                        <div>
                            <div
                                className={`flex mb-5 ${i % 2 === 0 && 'flex-row-reverse xl:ml-96'} xl:w-8/12 text-start items-center border-2 rounded-xl bg-white drop-shadow-2xl hover:translate-x-1 duration-700 ease-linear `}
                                key={i}>
                                <div
