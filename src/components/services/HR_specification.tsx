                ...
                </div>
                {
                    hr_feature.map((feature, idx) =>
                        <div key={idx} className="">
                            <div
                                className={`flex mb-4 ${idx % 2 === 0 && 'flex-row-reverse xl:ml-96 '} bg-blue-50 h-96 xl:w-8/12 text-start  items-center border-2 rounded-lg drop-shadow-2xl hover:-translate-y-1  ease-in-out duration-700`} key={idx}>
                                <div
                                ...
                                <img src={feature.featureImage} alt={feature.feature}
                                    className={`sm:max-md:hidden sm:max-md:absolute sm:max-md:-z-1 opacity-70 md:w-6/12`} />
                            </div>
                        </div>
