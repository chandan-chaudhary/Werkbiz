...
const HR_management :React.FC =()=>{
    return(
        <React.Fragment>
            <div
                className={'flex flex-col space-y-8 text-black bg-white mx-auto  p-5 h-full md:space-y-16 xl:h-screen '}>
                ...
                <div
                    ...
                    <h1 className={'text-4xl lg:text-6xl font-bold text-fuchsia-950 uppercase text-center '}>HR Management </h1>
                    <p className={'text-xl font-bold text-fuchsia-900 sm:max-xl:pb-12  xl:pt-10 xl:px-28 lg:text-2xl xl:text-3xl'}>Streamline your HR processes and empower your workforce with our innovative HR solutions. We handle everything from recruitment and onboarding to payroll and performance management, so you can focus on what matters most - growing your business.
                    </p>
