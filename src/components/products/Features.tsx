...
const Feature:React.FC =()=>{
    return(
        <div
            className={'absolute top-24 left-16 flex flex-col space-y-4 text-black  rounded-lg  border-b-4 border-x-2 border-gray-400 p-5 mt-2.5 bg-white shadow-2xl shadow-blue-300'}>
            ...
            <div className={' flex flex-row items-center space-x-5 bg-blue-200 py-4 px-8 rounded-lg hover:scale-90 ease-in duration-300'}>
