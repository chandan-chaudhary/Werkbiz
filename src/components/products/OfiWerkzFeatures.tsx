    ...
    return (
        <div className={'bg-white sm:max-lg:p-10'}>
            <div className={'flex flex-col text-black space-y-16 xl:space-y-12 md:space-y-28 text-center  md:pt-24 md:px-8 lg:px-12 xl:px-24'}>
                ...
                <h1 className={'text-4xl p-3 uppercase font-bold md:text-5xl'}>OfiWerkz Features</h1>
                <div className='h-0.5 w-36 bg-red-300'></div>
                </div>
                {
                    ofiWerkzFeatures.map((feature, idx) =>
                        <div>
                        <div key={idx} className={`flex ${idx %2 === 0 && 'flex-row-reverse lg:ml-96'} lg:w-8/12 text-start  border-2 drop-shadow-2xl bg-blue-50 rounded-xl hover:translate-x-1 duration-700 ease-linear`}>
